...
int Function EvaluateNearbyNpcs()
    ...
    int res = SkyrimNetApi.SendCustomPromptToLLM("ostimnet_nearby_npcs_game_master", "meta", "", self, "TTON_GameMaster", "ProcessNearbyNpcs")
...
int Function EvaluatePotentialParticipants(Actor intiator, Actor participant1, Actor participant2, Actor participant3, Actor participant4)
    ...
    int res = SkyrimNetApi.SendCustomPromptToLLM("ostimnet_evaluate_potential_partners", "meta", "", self, "TTON_GameMaster", "ProcessPotentialParticipants")
